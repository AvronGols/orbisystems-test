# leaflet-project
Тестовый проект, подразумевающий использование чистого JavaScript и картографической библиотеки Leaflet.

Исходные требования:
- На странице необходимо отобразить карту с маркерами, соответсвующими объектам из заданных файлов.
